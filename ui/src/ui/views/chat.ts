        ...
        <div class="agent-chat__talk-select-menu" role="listbox" aria-label=${params.label}>
          ${repeat(
            ...
            (entry) => {
              ...
              return html`
                <button
                  class="agent-chat__talk-select-option ${
                    isSelected ? "agent-chat__talk-select-option--selected" : ""
                  }"
      ...
      ${
        workspaceFiles.error
          ...
          : workspaceFiles.loading && files.length === 0
            ? html`
                <div class="chat-workspace-rail__state">Loading files...</div>
              `
            : files.length === 0
              ? html`
                  <div class="chat-workspace-rail__state">No workspace files</div>
                `
              : html`
                    ...
                    return html`
                      ...
                      >
                        ...
                        ${
                          file.missing
                            ? html`
                                <span class="chat-workspace-rail__file-badge">Missing</span>
                              `
                            : nothing
                        }
                      </button>
